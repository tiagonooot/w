...
const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
            ...
            + 'TEL;type=CELL;type=VOICE;waid=554497462158:+55 44 9746-2158\n' // WhatsApp ID + phone number
            + 'END:VCARD'
prefix = '.'
blocked = []
limitawal = '999999999'
...
//DATABASE X
			...
			const ownerNumber = ["5544997462158@s.whatsapp.net"] // replace this with your number
			...
			const isOwner = ownerNumber.includes(sender)
                        ...
                        const NomerOwner = '5544997462158@s.whatsapp.net'
                        const isEventon = isGroup ? event.includes(from) : false
                        const isRegister = checkRegisteredUser(sender)
                        pushname = client.contacts[sender] != undefined ? client.contacts[sender].vname || client.contacts[sender].notify : undefined

                        // Options
                        const botName = 'Tiago bot'
                        const ownerName = ''
